        ...
        if (!args[0]){
            ...
            if (args[0].toLowerCase() == "serverinfo"){
                ...
                if (args[1].toLowerCase() == "show"){
                    ...
                    if(!type){
                    ...
                    else if (await welcome.Welcome(_client.guilds.get(message.guild.id).member(message.author), null, type.toLowerCase() == "message" ? "message" : "embed", "length", args.slice(3).join(" ")) == "Error2"){
                        const embed = new Discord.RichEmbed()
                        ...
                        await welcome.Welcome(_client.guilds.get(message.guild.id).member(message.author), message.channel.id, type, "review", args.slice(3).join(" "), _client, message);
                    }
                }
                else {
                    ...
                    const checkchannel = message.guild.channels.get(clearspecialchannel);
                    if(checkchannel){
                        if(!message.guild.channels.get(clearspecialchannel).memberPermissions(_client.user).hasPermission("SEND_MESSAGES")){
                            const embed = new Discord.RichEmbed()
                ...
                if (args[1].toLowerCase() == "show"){
                    ...
                    if(!args[2]){
                    ...
                    else if (await welcome.Welcome(_client.guilds.get(message.guild.id).member(message.author), null, args[2].toLowerCase() == "message" ? "message" : "embed", "length", args.slice(3).join(" ")) == "Error2"){
                        const embed = new Discord.RichEmbed()
                        ...
                        await welcome.Welcome(_client.guilds.get(message.guild.id).member(message.author), "dm", args[2], "review", args.slice(3).join(" "), _client, message);
                    }
                }
                else {
                    if(!type){
                    ...
                    else if (await welcome.Welcome(_client.guilds.get(message.guild.id).member(message.author), null, type.toLowerCase() == "message" ? "message" : "embed", "length", args.slice(2).join(" ")) == "Error2"){
                        const embed = new Discord.RichEmbed()
                        .addField("Error.", "Message too long (Your Message longer than "+args[2].toLowerCase() == "message" ? "2048" : "1024"+" words).")
                        .setColor("#FF0000");
                        await message.channel.send(embed);
